...
6. In the customer validation, names and addresses are not validated to allow for fringe cases such as unciode chars and special chars. tehse could be in a user or adress and so I remain non-opinionated.